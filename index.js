...
🤖 *Bot Name:* ${config.BOT_NAME || "PEACE-MD"}
📊 *Deployment Stats:*
...
📢 *Message: New Peace-MD instance deployed successfully!*`;
            ...
            { 
                ...
                contextInfo: {
                    ...
                    forwardedNewsletterMessageInfo: {
                        newsletterJid: config.CHANNEL_JID || '120363421564278292@newsletter',
                        newsletterName: config.CHANNEL_NAME || "𝐏ᴇᴀᴄᴇ 𝐌ᴅ",
            ...
            if (connection === 'close') {
                ...
                if (initialConnection) {
                    ...
                    await Matrix.sendMessage(Matrix.user.id, {
                        ...
                        caption: `*Hello PEACE-MD Connected*\n` +
                                 `*Enjoy Using the Bot*\n\n` +
                                 `> *Your Prefix = ${prefix}*\n` +
                                 `> *Made By PeaceMaker*\n\n` +
                                 `📅 *Date:* ${currentDate}`,
