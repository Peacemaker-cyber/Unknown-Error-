...
const config = {
  ...
  SESSION_ID: process.env.SESSION_ID || "PEACE~4IxXzZSD#vr0cAFNJs7jgkSFKWAZQx_2FC99m5jbCnCRSbV19vvg",
  SESSION_NAME: process.env.SESSION_NAME || "PEACE~",
  ...
  CAPTION: process.env.CAPTION || "Powered by PeaceMaker",
  ...
  CHANNEL_JID: process.env.CHANNEL_JID || "120363421564278292@newsletter",
  CHANNEL_NAME: process.env.CHANNEL_NAME || "𝐏ᴇᴀᴄᴇ 𝐌ᴅ",
  ...
  STATUS_READ_MSG: process.env.STATUS_READ_MSG || 'Status Viewed By Peace-MD',
